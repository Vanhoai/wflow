...
class CompanyNewJobWidget extends StatefulWidget {
  final ScrollController scrollController;
  final TabController tabController;
  const CompanyNewJobWidget({super.key, required this.scrollController, required this.tabController});

  @override
  State<CompanyNewJobWidget> createState() => _CompanyNewJobWidgetState();
}

class _CompanyNewJobWidgetState extends State<CompanyNewJobWidget> {
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text('New jobs', style: themeData.textTheme.displayMedium),
        ),
        ConstrainedBox(
