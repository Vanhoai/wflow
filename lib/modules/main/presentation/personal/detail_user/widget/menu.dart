...
class UserMenu extends StatelessWidget {
  UserMenu({super.key, required this.child, this.margin = const EdgeInsets.all(20), required this.userID});
  final Widget child;
            ...
            onPressed: () {
              ...
              if (instance.get<AppBloc>().state.userEntity.isVerify) {
                Navigator.of(context).pushNamed(RouteKeys.reportScreen,
                    arguments: ArgumentsReport(type: ReportEnum.USER, target: userID));
              } else {
