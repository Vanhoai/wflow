...
class MainChatBloc extends Bloc<MainChatEvent, MainChatState> {
  ...
  static MainChatState initState() {
    List<Message> chat = [
      ...
      Message(
          id: '2',
          content: 'https://www.learningcontainer.com/wp-content/uploads/2020/02/Kalimba.mp3',
          type: 'record',
          createAt: DateTime.now().toString()),
      Message(
          id: '2',
  ...
  FutureOr<void> sendMessage(SendMessageEvent event, Emitter<MainChatState> emit) {
    Map<String, dynamic> data = {'id': event.message.id, 'content': event.message.content, 'type': event.message.type};
