...
class _IntroductionScreenState extends State<IntroScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    PageDecoration pageDecoration = PageDecoration(
        titleTextStyle:
            const TextStyle(fontSize: 28.0, fontFamily: 'null', fontWeight: FontWeight.w700, color: AppColors.primary),
    ...
    return SafeArea(
      ...
      skipOrBackFlex: 0,
      nextFlex: 0,
      skip: const Text('Skip', style: TextStyle(fontWeight: FontWeight.w400)),
      next: const Icon(Icons.arrow_forward),
      done: const Text('Done', style: TextStyle(fontWeight: FontWeight.w400)),
