...
class SearchBarContractHistory extends StatefulWidget {
  const SearchBarContractHistory({
    super.key,
  ...
  @override
  State<SearchBarContractHistory> createState() =>
      _SearchBarContractHistoryState();
}

class _SearchBarContractHistoryState extends State<SearchBarContractHistory> {
  @override
