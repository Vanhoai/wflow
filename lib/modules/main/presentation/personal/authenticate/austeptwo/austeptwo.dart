                        ...
                        case 0 :
                          return  Row(
                            ...
                            children: [
                              ...
                              Text('Ảnh hợp lệ',style: TextTitle(size: 12, colors: AppColors.greenColor, fontWeight: FontWeight.w400 ),)
                            ],
                          );
                        case 1 :
                          return  Row(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              const Icon(Icons.cancel,color: AppColors.redColor,),
                              const SizedBox(width: 5,),
                              Text('Ảnh không hợp lệ',style: TextTitle(size: 12, colors: AppColors.redColor, fontWeight: FontWeight.w400 ),)
                            ],
                          );
                        default : return const SizedBox(height: 24,);
                      }
                    },),
                  ),
                  Align(
                      ...
                      child: Ink(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text('CHỤP ẢNH',style: TextTitle(size: 12, colors: AppColors.primary, fontWeight: FontWeight.w500 ),)
                          ],
                        ),
                      ),
                    ),
