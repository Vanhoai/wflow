          ...
          builder: (context, state) {
            _scrollController.addListener(() {
              if (_scrollController.position.maxScrollExtent == _scrollController.offset && !state.isLoadMore) {
                BlocProvider.of<SearchWorkBloc>(context).add(LoadMoreSearchWorkEvent(isLoadMore: !state.isLoadMore));
                BlocProvider.of<SearchWorkBloc>(context).add(const ScrollSearchWorkEvent());
              }
            });
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: RefreshIndicator(
                      onRefresh: () async =>
                          BlocProvider.of<SearchWorkBloc>(context).add(const RefreshSearchWorkEvent()),
