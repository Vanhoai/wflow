        ...
        body: Builder(
          builder: (context) {
            return RefreshIndicator(
              onRefresh: () async {
                context.read<BalanceBloc>().add(BalanceEventFetch(id: widget.balanceID));
                context.read<BalanceBloc>().add(TrackingEventFetch(id: widget.balanceID));
              },
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final date = DateFormat('dd/MM/yyyy')
                                    .format(DateTime.parse(trackingEntity.createdAt.toString()));
                                final time =
                                    DateFormat('HH:mm:ss').format(DateTime.parse(trackingEntity.createdAt.toString()));
